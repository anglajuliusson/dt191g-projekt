...
namespace Projektuppgift.Controllers
{
    public class AssociationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AssociationId,Name,ContactEmail")] Association association)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AssociationId,Name,ContactEmail")] Association association)
        {
