...
namespace Projektuppgift.Controllers
{
    public class BookingsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Bookings.Include(b => b.Association).Include(b => b.Facility);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookingId,FacilityId,AssociationId,StartDateTime,EndDateTime,Status")] Booking booking)
        {
