...
namespace Projektuppgift.Controllers
{
    public class FacilitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FacilityId,Name,Address,Description")] Facility facility)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FacilityId,Name,Address,Description")] Facility facility)
        {
